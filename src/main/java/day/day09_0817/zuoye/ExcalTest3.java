...
public class ExcalTest3 {
    ...
    private static List<Person> readExcal(String url, int sheetNum) throws Exception {
        ...
        try {
            ...
            inputStream = ExcalTest3.class.getResourceAsStream(url);
            ...
            for (int i = 1; i <= lastRowNum; i++) {
                ...
                for (int j = 0; j < lastCellNum; j++) {
                    ...
                    /*
                     * if (j==0) { person.setId(stringCellValue); }else if
                     * (j==1) { person.setName(stringCellValue); }else if (j==2)
