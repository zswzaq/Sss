package day.day13_0829.test2;

import org.testng.annotations.Test;

import day.day13_0829.test1_testNg.HttpTools;
...
public class Register_Test_Case_Data3 {
    ...
    public Object[][] getData() {
        ...
        // Object[] arr = {readList.get(i)};
        // registerDatas[i] = arr;// 2.再放二维
        // }
        int i = 0;
        for (Object objects : readList) {
            Object[] arr = { objects };
            registerDatas[i] = arr;
            i++;
        }
